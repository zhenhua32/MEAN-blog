...
markController.controller('loginC', ['$scope', 'loginS', '$location', 'isLoginS',
    function($scope, loginS, $location, isLoginS) {
        $scope.userName = null;
...
markController.controller('sidenavC', ['$scope', '$rootScope', '$mdSidenav', 'getSessionS', 'logoutS', 'getIconS',
    function($scope, $rootScope, $mdSidenav, getSessionS, logoutS, getIconS) {
...
markController.controller('saveC', ['$scope', '$rootScope', 'saveS', 'defaultTinymceOptions',
    function($scope, $rootScope, saveS, defaultTinymceOptions) {
